...
public class A_Array {
	...
	public void method1() {
		 ...
		 */
//		System.out.println(score); //[I@37d31475
...
//		score2= {100,90,80,70,60}//이건 안됨!
	...
	public void method3() {
		...
		/*
		 * 향상된 for문 - 자바 5부터 배열 및 컬렉션 클래스를 좀 더 쉽게 처리할 목적으로 제공 - 증감식을 사용하지 않고 배열 및 컬렉션의
		 * 요소 개수만큼 반복하고 for문을 종료
		 */
		for (int s : score) {
...
//		System.out.println(copy.length); //NullPointerException에러
