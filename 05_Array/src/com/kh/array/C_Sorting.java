...
public class C_Sorting {
	...
	public void method1() {
		...
		Arrays.sort(arr);//DualPivotQuicksort <-Ctrl +마우스
	...
	public void method3() {
		...
		System.out.println("최대값 : " + score[score.length]);
	...
	/*
	 * 삽입 정렬(intsertion sort)
	 * -동작 원리는 직관적,선택 정렬에 비해서는 구현 닌이도가 높
	 * -필요할 때만 위치를 바꾸므로 '데이터가 거의 정렬되어 있을
	 * 
	 * 7,5,9,0,3,1,6,2,4,8
	 * 5,7,9,0,3,1,6,2,4,8
	 * 0,5,7,9,3,1,6,2,4,8
