...
//		a.method4();
	...
	public void method2() {
		...
		// 3. substring(int beginIndex) : String - 문자열의 beginIndex 위치에서붜 끝까지의 문자열을 새로 생성해서 리턴
		...
		//    indexOf(char ch) :int - 전달받은 ch의 인덱스를 리턴 
		...
		// 6. toUpperCase() / to LowerCase() : String - 문자열을 모두 대/소문자로 변경한 새로운 문자열을 생성해서 리턴 
		...
		// 8. toCharArray() : char[] - 문자열의 문자들을 문자 배열에 담아서 해당 배열의 주소값을 리턴
	...
	public void method3() {
		...
		// StringBuilder 클래스의 생성자의 정수값을 전달해주면 해당 크기 만큼의 버퍼가 생성
		StringBuilder sb2 =  new StringBuilder(30);
		System.out.println("sb2의 문자열 길이 : " + sb2.length()); // 0
		System.out.println("sb2의 버퍼의 크기 : " + sb2.capacity()); // 30
		
		// StringBuilder 클래스의 문자열을 전달해주면 문자열 크기 + 16 만큼의 버퍼가 생성
