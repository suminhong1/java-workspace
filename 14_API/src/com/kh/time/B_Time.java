...
//		b.method3();
	...
	public void method1() {
		...
		// 날짜 조작
		LocalDateTime plusDays = now.plusDays(1).plusMonths(2).plusYears(1).plusMinutes(50);
		...
		LocalDateTime withDays = now.withYear(2025).withMonth(3).withDayOfMonth(1).withHour(2);
	...
	/*
	 * Period와 Duration - 날짜와 시간 간격을 표현하기 위한 클래스 
	 * - period :두 날짜 간의 차이
	 * - Duration : 시간의 차이
	 */
	public void method2() {
		...
		System.out.println("years2 : " + pe.get(ChronoUnit.YEARS));
		...
		pe = pe.plusYears(3).multipliedBy(2); // 3년을 더하고 , 2배를
	...
	public void method3() {
		...
		date = LocalDate.parse("2023.05.11", DateTimeFormatter.ofPattern("yyy.MM.dd"));
		System.out.println(date);
