...
public class C_For {
	 ...
	 * 
	 * - 주어진 횟수만큼 코드를 반복 실행하는 구문 - 초기식은 반복문이 수행될 때 단 한번만 실행되는 구문으로 반복문 안에서 사용하게 될
...
//		}
	 ...
	 * continue문
	 * 
	 * - continue문은 반복문 안에서 사용 - 반복문 안에서 continue문을 만나게 되면 "현재 구문"을 종료 - 반복문을 벗어나는건
	 * 아님! 다음 반복을 계속 수행
	 */
	// 1~10 사이의 짝수만 출력
	public void method4() {
