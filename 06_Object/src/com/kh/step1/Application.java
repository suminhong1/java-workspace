...
public class Application {
	 ...
	 * 2. 캡슐화 : 객체의 속성(필드)와 기능(메소드)을 하나로 묶고 실제 구현 내용을 감추는것
	 * 3. 상속  :하나의 객체가 가지고 있는 속성(필드)과 기능(메소드)를 다른객체가 물려받는것
	...
	public static void main(String[] args) {
		 ...
		 * - 객채의 주소값을 참조 타입인 변수에 저장해서 객체 사용
		 */
		...
		tv.power();
		System.out.println("TV상태 : " + tv.power); //true
