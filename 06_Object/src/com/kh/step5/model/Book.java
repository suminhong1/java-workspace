...
public class Book {
	...
	/*
	 * 캡슐화(Encapsulation)
	 * - 정보은닉: 외부에서 객체 접근하는데 있어서 정보를 숨기고 객채의 연산을 통해서만 접근이 가능하게 하는 것
	 * - 외부에서 특정 객체의 데이터 및 함수를 직접 접근을 막음으로써 변경을 못하게 유지보수나 확장시 오류의 범위를 최소하 할 수 있고,
	 * - 객체 내 정보손상, 오용을 방지하고, 조작법이 바뀌어도 사용방법 자체는 바뀌지 않고, 데이터가 변경되어도 다른 객체에 영향을 주지 않기 떄문에 독립성이 좋고,
